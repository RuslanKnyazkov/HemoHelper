...
SECRET_KEY = 'django-insecure-t^r&uen%5o1g2)8v15zv5iuw7p1e8_f87cw8!56@2q=5yq3ekc'
...
# Where `collectstatic` gathers files for deployment (e.g. in production)
...
# Для DRF - отключаем рендеринг HTML в API
REST_FRAMEWORK = {
